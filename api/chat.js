...
let ui_pending_reason = null;
  ...
  // ===============================
  // PENDING MEAL RESOLUTION
  // If we previously asked "what meal is this?" and user replies "lunch"
  // ===============================
  if (customerGid) {
    try {
      ...
      if (
        ...
        // Convert the user's one-word reply to a proper meal type
        ...
        if (mt) {
          // Call nutrition on the pending raw_text and log it
          const proto =
          ...
          // Clear pending no matter what (avoid getting stuck)
